            ...
            <form action="{{ route('customer.book.store') }}" method="POST"
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div
                        ...
                        <div class="mb-6 pl-0 md:pl-14">
                            <div
                                class="flex overflow-x-auto pb-3 hide-scrollbar gap-2 -mx-1 px-1 sm:mx-0 sm:px-0 sm:flex-wrap">
                                <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-pink-500 text-white border border-transparent shadow-sm transition-all"
                                    data-filter="all">ทั้งหมด</button>
                                {{-- <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-slate-600 hover:bg-pink-50 dark:hover:bg-slate-600 hover:text-pink-600 hover:border-pink-200 transition-all"
                                    data-filter="9-10">9-10 kg</button>
                                <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-slate-600 hover:bg-pink-50 dark:hover:bg-slate-600 hover:text-pink-600 hover:border-pink-200 transition-all"
                                    data-filter="13-15">13-15 kg</button>
                                <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-slate-600 hover:bg-pink-50 dark:hover:bg-slate-600 hover:text-pink-600 hover:border-pink-200 transition-all"
                                    data-filter="18-20">18-20 kg</button>
                                <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-slate-600 hover:bg-pink-50 dark:hover:bg-slate-600 hover:text-pink-600 hover:border-pink-200 transition-all"
                                    data-filter="25-27">25-27 kg</button>
                                <button type="button"
                                    class="pkg-filter-btn shrink-0 whitespace-nowrap px-5 py-2 rounded-full text-sm font-bold bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-slate-600 hover:bg-amber-50 dark:hover:bg-slate-600 hover:text-amber-600 hover:border-amber-200 transition-all"
                                    data-filter="พับ">แบบพับด้วย</button> --}}
                            </div>
                        </div>
                        ...
                        <div class="flex overflow-x-auto custom-scrollbar pb-6 pt-2 gap-5 pl-0 md:pl-14 snap-x">
                            @foreach ($packages as $package)
                                <label
                                    class="cursor-pointer relative group block h-full shrink-0 w-[260px] md:w-[280px] snap-start package-card-wrapper"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <div
                                                class="w-20 h-20 mx-auto bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shadow-sm mb-4 transition-all peer-checked:shadow-pink-200 overflow-hidden border border-gray-100 dark:border-slate-600">
                                                @if ($package->image_path)
                                                    <img src="{{ asset('storage/' . $package->image_path) }}"
                                                        class="w-full h-full object-cover">
                                                @else
                                                    <i
                                                        class="fa-solid fa-shirt text-3xl text-gray-300 dark:text-gray-500 peer-checked:text-pink-500 transition-colors"></i>
                                                @endif
                                            </div>
                                        ...
                                        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-slate-600">
                                            ...
                                            <div
                                                class="mt-3 pt-3 border-t border-dashed border-gray-200 dark:border-slate-600 flex items-center justify-between">
                                                ...
                                                <div class="flex items-center border border-gray-200 dark:border-slate-600 rounded-lg bg-gray-50 dark:bg-slate-800 z-20 relative"
                                                    ...
                                                    <button type="button"
                                                        class="pkg-qty-btn px-2.5 py-1 text-gray-500 hover:text-pink-500 transition-colors"
                                                        data-step="-1" data-pkg="{{ $package->id }}">
                                                        <i class="fa-solid fa-minus text-[10px] pointer-events-none"></i>
                                                    </button>
                                                    <input type="number" name="extra_dry_qty[{{ $package->id }}]"
                                                        id="extra-dry-{{ $package->id }}" value="0" min="0"
                                                        max="10"
                                                        class="w-6 text-center text-xs font-bold border-none p-0 focus:ring-0 bg-transparent pointer-events-none dark:text-gray-100"
                                                        readonly>
                                                    <button type="button"
                                                        class="pkg-qty-btn px-2.5 py-1 text-gray-500 hover:text-pink-500 transition-colors"
                                                        data-step="1" data-pkg="{{ $package->id }}">
                                            ...
                                            <div class="addon-card relative p-4 rounded-2xl border-2 border-gray-100 dark:border-slate-600 bg-white dark:bg-slate-800 hover:border-pink-300 dark:hover:border-pink-500 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md flex flex-col h-full justify-between gap-4"
                                                ...
                                                <div class="flex items-start gap-3 w-full">
                                                    ...
                                                    <div class="flex-1 min-w-0 break-words">
                                                        <p
                                                            class="addon-name-txt font-bold text-gray-800 dark:text-gray-100 text-sm md:text-base leading-snug mb-1">
                                                            {{ $addon['name'] }}</p>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            <div
                                ...
                                3</div>
                            <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">
                                วันที่และรอบเวลารับผ้า</h3>
                        </div>

                        {{-- เลือกวันที่ --}}
                        <div class="mb-8 pl-0 md:pl-14">
                            <label
                                class="block font-bold text-gray-700 dark:text-gray-300 mb-3">ต้องการให้ไรเดอร์เข้ารับผ้าวันไหน?
                                <span class="text-rose-500">*</span></label>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {{-- วันนี้ --}}
                                <label class="cursor-pointer relative group">
                                    <input type="radio" name="pickup_date" value="today"
                                        class="peer sr-only pickup-date-radio" required
                                        @if ($isClosedToday) disabled @else {{ old('pickup_date', 'today') == 'today' ? 'checked' : '' }} @endif>
                                    <div
                                        ...
                                        @else 
                                            bg-gray-50/50 dark:bg-slate-700/30 border-gray-100 dark:border-slate-600 hover:border-pink-300 dark:hover:border-pink-500 peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-slate-700 @endif">
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <p class="font-bold text-gray-800 dark:text-gray-100 text-base">วันนี้</p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $today->locale('th')->translatedFormat('j F Y') }}</p>
                                            </div>
                                            @if ($isClosedToday)
                                                <span
                                                    class="bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 text-[10px] px-2 py-1 rounded-md font-bold border border-rose-200 dark:border-rose-800">หมดเวลาจอง</span>
                                            @else
                                                <i
                                                    class="fa-solid fa-check-circle text-xl text-pink-500 scale-0 opacity-0 peer-checked:scale-100 peer-checked:opacity-100 transition-all"></i>
                                            @endif
                                        </div>
                                    </div>
                                </label>
                                ...
                                {{-- พรุ่งนี้ --}}
                                <label class="cursor-pointer relative group">
                                    <input type="radio" name="pickup_date" value="tomorrow"
                                        class="peer sr-only pickup-date-radio" required
                                        {{ old('pickup_date') == 'tomorrow' || $isClosedToday ? 'checked' : '' }}>
                                    <div
                                        class="p-4 rounded-2xl border-2 border-gray-100 dark:border-slate-600 bg-gray-50/50 dark:bg-slate-700/30 hover:border-pink-300 dark:hover:border-pink-500 peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-slate-700 transition-all duration-200">
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <p
                                                    class="font-bold text-blue-600 dark:text-blue-400 text-base flex items-center gap-2">
                                                    พรุ่งนี้ <span
                                                        class="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-[10px] px-2 py-0.5 rounded-full border border-blue-200 dark:border-blue-800">จองล่วงหน้า</span>
                                                </p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $tomorrow->locale('th')->translatedFormat('j F Y') }}</p>
                                            </div>
                                            <i
                                                class="fa-solid fa-check-circle text-xl text-pink-500 scale-0 opacity-0 peer-checked:scale-100 peer-checked:opacity-100 transition-all"></i>
                                        </div>
                        ...
                        <div class="pl-0 md:pl-14">
                            <label class="block font-bold text-gray-700 dark:text-gray-300 mb-3">เลือกรอบเวลา <span
                                    class="text-rose-500">*</span></label>
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach ($timeSlots as $slot)
                                    @php
                                        // ดึงเวลาเริ่มและสิ้นสุดจากชื่อรอบ เช่น "09:00 - 12:00"
                                        $times = explode('-', str_replace(' ', '', $slot->round_name));
                                        $startTime = $times[0] ?? '00:00';
                                        $endTime = $times[1] ?? '23:59'; // ใช้เวลาสิ้นสุดเพื่อเทียบ
                                    @endphp
                                    <label class="cursor-pointer relative group time-slot-wrapper"
                                        data-start-time="{{ $startTime }}" data-end-time="{{ $endTime }}">
                                        <input type="radio" name="time_slot_id" value="{{ $slot->id }}"
                                            class="peer sr-only time-slot-radio" required
                                            {{ old('time_slot_id') == $slot->id ? 'checked' : '' }}>
                                        <div
                                            class="px-5 py-4 rounded-2xl border-2 border-gray-100 dark:border-slate-600 bg-gray-50/50 dark:bg-slate-700/30 hover:border-pink-300 dark:hover:border-pink-500 peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-slate-700 transition-all duration-200 flex items-center justify-between group-hover:shadow-sm 
                    peer-disabled:opacity-50 peer-disabled:bg-gray-100 dark:peer-disabled:bg-slate-800 peer-disabled:cursor-not-allowed peer-disabled:border-gray-200">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span
                                                    class="font-bold text-gray-700 dark:text-gray-200 slot-name-text">{{ $slot->round_name }}</span>
                                            </div>
                                            <i
                        ...
                        {{-- เช็กสถานะคิว --}}
                        @php
                            $allQueues = $todayQueues
                                ->map(function ($q) {
                                    $q->date_group = 'today';
                                    return $q;
                                })
                                ->concat(
                                    $tomorrowQueues->map(function ($q) {
                                        $q->date_group = 'tomorrow';
                                        return $q;
                                    }),
                                );
                        @endphp
                        ...
                        <div class="pl-0 md:pl-14 mt-8 pt-6 border-t border-dashed border-gray-200 dark:border-slate-700">
                            <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                                ...
                                <span id="queue-counter-badge"
                                    class="text-sm font-semibold bg-pink-100 text-pink-700 dark:bg-slate-700 dark:text-pink-400 px-3 py-1.5 rounded-full shadow-sm">
                            ...
                            @if ($allQueues->isEmpty())
                                <div
                                    class="text-center py-5 bg-gray-50 dark:bg-slate-700/30 rounded-2xl border border-dashed border-gray-200 dark:border-slate-600">
                                    <p class="text-gray-500 dark:text-gray-400 text-sm">ยังไม่มีคิวจอง 🎉
                                        คุณสามารถจองเป็นคิวแรกได้เลย!</p>
                                </div>
                            @else
                                <div id="queue-list-container" class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    @foreach ($allQueues as $index => $queue)
                                        <div class="queue-item flex items-center gap-3 p-3 rounded-2xl border transition-colors {{ $queue->user_id == Auth::id() ? 'border-pink-300 bg-pink-50/50 dark:bg-slate-700/80 dark:border-pink-500/50' : 'border-gray-100 dark:border-slate-600 bg-gray-50 dark:bg-slate-700/30' }}"
                                            ...
                                            data-date="{{ $queue->date_group }}">
                                            <div
                                                class="shrink-0 w-8 h-8 {{ $queue->user_id == Auth::id() ? 'bg-pink-500 text-white' : 'bg-white dark:bg-slate-800 text-gray-500 dark:text-gray-300' }} rounded-full flex items-center justify-center font-bold text-xs shadow-sm border border-gray-200 dark:border-slate-600">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-0.5">
                                                    ...
                                                    {{ $queue->timeSlot->round_name ?? 'ไม่ระบุ' }}
                                                </p>
                                            </div>
                                            @php
                                                $statusColors = [
                                            ...
                                            <div class="shrink-0">
                                                <span
                                                    class="text-[10px] font-bold px-2 py-1 rounded-md {{ $statusColors[$queue->status] ?? 'bg-gray-100 text-gray-600' }}">
                                ...
                                <div id="empty-slot-message"
                                    class="hidden text-center py-5 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-200 dark:border-blue-800 mt-3">
                                    <i class="fa-solid fa-sparkles text-blue-500 mb-2 text-xl"></i>
                                    <p class="text-blue-800 dark:text-blue-300 text-sm font-medium">รอบเวลานี้ยังว่างอยู่!
                                        คุณสามารถจองเป็นคิวแรกของรอบนี้ได้เลย</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4 mb-6">
                            <div
                                class="shrink-0 bg-gradient-to-br from-pink-400 to-pink-600 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold shadow-md text-lg">
                                5</div>
                            <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">สถานที่ และ
                                หมายเหตุ</h3>
                        </div>
                        ...
                        <div class="pl-0 md:pl-14 space-y-5">
                            <div>
                                <div class="flex flex-wrap justify-between items-end gap-2 mb-2">
                                    <label
                                        class="block font-bold text-gray-700 dark:text-gray-300">ที่อยู่ปัจจุบันสำหรับรับ-ส่งผ้า
                                        <span class="text-rose-500">*</span></label>
                                    @if (Auth::user()->delivery_distance !== null)
                                        <span
                                            class="text-[11px] bg-sky-50 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 px-2.5 py-1 rounded-lg border border-sky-200 dark:border-sky-800 font-bold">
                                            <i class="fa-solid fa-route"></i> ระยะทางร้านประเมิน:
                                            {{ Auth::user()->delivery_distance }} กม.
                                        </span>
                                    @else
                                        <span
                                            class="text-[10px] bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 px-2 py-1 rounded-lg border border-amber-200 dark:border-amber-800 font-bold">
                                ...
                                <button type="button" onclick="getLocation()" id="btn-get-location"
                                    class="mb-3 flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/50 px-4 py-2 rounded-xl transition-colors text-sm font-bold">
                                ...
                                <textarea id="pickup_address" name="pickup_address" rows="3" required
                                    placeholder="ระบุบ้านเลขที่, ชื่อหมู่บ้าน, คอนโด, ชั้น, ห้อง..."
                                    class="w-full p-4 rounded-2xl border-2 border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700/50 text-gray-800 dark:text-gray-100 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10 outline-none transition-all resize-none leading-relaxed">{{ old('pickup_address', Auth::user()->address) }}</textarea>
                                ...
                                <p id="location-status" class="mt-2 text-sm text-gray-500 dark:text-gray-400 font-medium">
                                </p>
                            </div>
                            ...
                            <div>
                                <label class="block font-bold text-gray-700 dark:text-gray-300 mb-2">หมายเหตุ / คำขอพิเศษ
                                    (ถ้ามี)</label>
                                <textarea name="customer_note" rows="2" placeholder="เช่น ฝากไว้ที่นิติบุคคล, รบกวนแยกซักผ้าสีขาว, ฯลฯ"
                                    class="w-full p-4 rounded-2xl border-2 border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700/50 text-gray-800 dark:text-gray-100 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10 outline-none transition-all resize-none leading-relaxed">{{ old('customer_note') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <aside class="lg:col-span-4 mt-8 lg:mt-0 relative">
                    <div class="lg:sticky lg:top-24 space-y-5">
                        <div
                            class="rounded-3xl bg-white dark:bg-slate-800 border-2 border-pink-100 dark:border-slate-700 shadow-xl shadow-pink-100/50 dark:shadow-none flex flex-col min-h-[400px]">
                            <div
                                class="bg-pink-50 dark:bg-slate-700/50 px-6 py-4 border-b border-pink-100 dark:border-slate-600 shrink-0">
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                <div id="summary-items-list"
                                    class="space-y-3 mb-6 flex-1 overflow-y-auto pr-2 custom-scrollbar">
                                ...
                                <div
                                    class="pt-4 border-t border-dashed border-gray-200 dark:border-slate-600 flex justify-between items-end shrink-0">
                                ...
                                <div class="mt-4 pt-4 border-t border-dashed border-gray-200 dark:border-slate-600">
                                    <button type="button" id="show-qr-btn"
                                        class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold py-3.5 rounded-2xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                                        disabled>
    ...
    <script>
        ...
        function recalculateSummary() {
            ...
            if (selectedPackage) {
                ...
                listHTML +=
                    `<div class="text-sm text-gray-400 dark:text-gray-500 italic text-center py-4">กรุณาเลือกแพ็กเกจเพื่อดูสรุปรายการ</div>`;
            }
                ...
                navigator.geolocation.getCurrentPosition(
                    async function(position) {
                            ...
                            statusText.innerHTML =
                                "ระบบได้รับพิกัด GPS เรียบร้อยแล้ว (คุณสามารถแก้ไขที่อยู่ให้ชัดเจนขึ้นได้)";
        ...
        function updateQueueDisplay() {
            ...
            // 🌟 ล็อครอบเวลาที่ผ่านมาแล้ว (ถ้าเลือกวันนี้)
            const now = new Date();
            ...
            document.querySelectorAll('.time-slot-wrapper').forEach(wrapper => {
                ...
                const endTime = wrapper.dataset.endTime; // ใช้เวลาสิ้นสุดของรอบ เช่น "12:00" หรือ "17:00"

                // ถ้าเลือกวันนี้ และเวลาปัจจุบัน เลยเวลา "สิ้นสุด" ของรอบนั้นไปแล้ว ให้ล็อค
                // เช่น ตอนนี้ 14:18 -> รอบ 09:00-12:00 จะถูกล็อค (14:18 > 12:00)
                // แต่รอบ 13:00-17:00 จะกดได้ปกติ (14:18 < 17:00)
                if (checkedDate === 'today' && currentTimeStr > endTime) {
                    radio.disabled = true;
                    if (radio.checked) radio.checked = false; // ยกเลิกการเลือกถ้ารอบนั้นถูกล็อค
                } else {
                    // ถ้าเลือกพรุ่งนี้ หรือยังไม่เลยเวลาสิ้นสุดของวันนี้ ให้กดได้ตามปกติ
                    radio.disabled = false;
                }
            });

            // โค้ดส่วนล่างสำหรับการแสดงผลคิวยังเหมือนเดิม
            ...
            if (queueCounterBadge) queueCounterBadge.innerHTML =
                `<i class="fa-solid fa-filter"></i> ${slotName}: ${visibleCount} คิว`;

            if (emptySlotMessage) {
                let totalForDate = 0;
                queueItemsList.forEach(item => {
                    if (item.dataset.date === checkedDate) totalForDate++;
                });
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-[fadeIn_0.2s_ease-out]">
                ...
                <div class="p-6">
                    ...
                    <div class="text-center mb-4">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">ยอดชำระทั้งหมด</p>
                    ...
                    <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-4 mb-4">
                        <p class="text-sm text-emerald-800 dark:text-emerald-200 flex items-start gap-2">
                            ...
                            <span>สแกน QR เพื่อชำระล่วงหน้า หรือเลือกจ่ายปลายทางก็ได้</span>
                        </p>
                    </div>
                    <div class="space-y-3">
                        <button type="button" id="qr-copy-amount"
        ...
        showQrBtn?.addEventListener('click', function() {
            if (currentGrandTotal > 0) {
                document.getElementById('qr-amount').textContent = '฿' + currentGrandTotal.toLocaleString('th-TH');
